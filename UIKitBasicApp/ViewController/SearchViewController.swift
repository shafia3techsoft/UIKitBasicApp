...
class SearchViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    ...
    var filteredAnimeList: [AnimeMovie] = []
    ...
    override func viewDidLoad() {
        ...
        tableView.backgroundColor = .lightPink
...
//        """
//            ),
//            // ... you can continue the same way for Death Note, MHA, FMA, DBZ, Bleach, Jujutsu Kaisen, Tokyo Ghoul, Hunter x Hunter
//        ]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.animeImageView.layer.cornerRadius = 10
        cell.animeImageView.clipsToBounds = true

        cell.backgroundColor = .lightPink
        cell.contentView.layer.cornerRadius = 15
        cell.contentView.backgroundColor = anime.backgroundColor
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        print("Selected: \(filteredAnimeList[indexPath.row].name)")
